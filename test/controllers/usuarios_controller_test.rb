...
class UsuariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create usuario" do
    assert_difference('Usuario.count') do
      post usuarios_url, params: { usuario: { contraseña: @usuario.contraseña, nombre: @usuario.nombre } }
    end
  ...
  test "should update usuario" do
    patch usuario_url(@usuario), params: { usuario: { contraseña: @usuario.contraseña, nombre: @usuario.nombre } }
