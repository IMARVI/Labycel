...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { fecha_final: @proyecto.fecha_final, fecha_inicio: @proyecto.fecha_inicio, nombre: @proyecto.nombre } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { fecha_final: @proyecto.fecha_final, fecha_inicio: @proyecto.fecha_inicio, nombre: @proyecto.nombre } }
